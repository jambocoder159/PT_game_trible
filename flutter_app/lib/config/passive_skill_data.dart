...
class PassiveSkillData {
  ...
  static const blazePassives = <PassiveSkillDefinition>[
    PassiveSkillDefinition(
      ...
      goldCost: 300, materialCost: {MaterialType.commonShard: 3, MaterialType.passiveGem: 1},
    ...
    PassiveSkillDefinition(
      ...
      goldCost: 600, materialCost: {MaterialType.advancedShard: 2, MaterialType.passiveGem: 1},
    ...
    PassiveSkillDefinition(
      ...
      goldCost: 1000, materialCost: {MaterialType.advancedShard: 3, MaterialType.passiveGem: 2},
    ...
    PassiveSkillDefinition(
      ...
      goldCost: 1500, materialCost: {MaterialType.rareShard: 2, MaterialType.passiveGem: 3},
  ...
  static const terraPassives = <PassiveSkillDefinition>[
    PassiveSkillDefinition(
      ...
      goldCost: 400, materialCost: {MaterialType.commonShard: 4, MaterialType.passiveGem: 1},
      unlockAtAgentLevel: 5,
    ),
    PassiveSkillDefinition(
      ...
      goldCost: 800, materialCost: {MaterialType.advancedShard: 2, MaterialType.passiveGem: 1},
    ...
    PassiveSkillDefinition(
      ...
      goldCost: 1200, materialCost: {MaterialType.advancedShard: 3, MaterialType.passiveGem: 2},
    ...
    PassiveSkillDefinition(
      ...
      goldCost: 2000, materialCost: {MaterialType.rareShard: 2, MaterialType.passiveGem: 3},
