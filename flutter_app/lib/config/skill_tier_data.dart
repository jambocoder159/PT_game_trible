...
class SkillTierData {
  ...
  static const blazeSkillTiers = <SkillTierDefinition>[
    ...
    SkillTierDefinition(
      ...
      multiplierBonus: 0.3,
      goldCost: 300, materialCost: {MaterialType.commonShard: 5, MaterialType.skillCore: 1},
    ),
    SkillTierDefinition(
      ...
      goldCost: 800, materialCost: {MaterialType.advancedShard: 3, MaterialType.skillCore: 2},
    ),
    SkillTierDefinition(
      ...
      goldCost: 1500, materialCost: {MaterialType.advancedShard: 5, MaterialType.skillCore: 3, MaterialType.rareShard: 1},
    ),
    SkillTierDefinition(
      ...
      goldCost: 3000, materialCost: {MaterialType.rareShard: 3, MaterialType.skillCore: 5},
    ),
  ];
