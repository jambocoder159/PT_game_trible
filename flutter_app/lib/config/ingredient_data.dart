...
class IngredientDefinitions {
  ...
  static const flour = IngredientDefinition(
    ...
    name: '麵粉',
    emoji: '🌾',
    tier: IngredientTier.common,
    bottleColor: BlockColor.coral,
    bottleLevelRequired: 1,
    energyCost: 30,
    sellPrice: 5,
  );
  ...
  static const egg = IngredientDefinition(
    ...
    name: '雞蛋',
    emoji: '🥚',
    tier: IngredientTier.uncommon,
    bottleColor: BlockColor.coral,
    bottleLevelRequired: 3,
    energyCost: 60,
    sellPrice: 12,
  );
  ...
  static const honey = IngredientDefinition(
    ...
    name: '蜂蜜',
    emoji: '🍯',
    tier: IngredientTier.rare,
    bottleColor: BlockColor.coral,
    bottleLevelRequired: 7,
    energyCost: 120,
    sellPrice: 30,
  );
  static const goldenSyrup = IngredientDefinition(
    ...
    name: '金色糖漿',
    emoji: '🥇',
    tier: IngredientTier.epic,
    bottleColor: BlockColor.coral,
    bottleLevelRequired: 9,
    energyCost: 180,
    sellPrice: 50,
  );
  ...
  static List<IngredientDefinition> all = const [
    ...
    // 裝飾
    powderedSugar, chocoChips, fruitSlices, goldLeaf, rainbowSprinkles,
    magicStardust,
    // 夜甜點
    cocoaPowder, brownSugar, darkChocolate, coffeeGrounds, purpleYam,
    moonlightEssence,
  ];
  ...
  /// 取得某瓶在指定等級下可產出的食材
  static List<IngredientDefinition> getAvailable(
      BlockColor color, int bottleLevel) {
    return all
        .where((i) =>
            i.bottleColor == color && i.bottleLevelRequired <= bottleLevel)
        .toList();
  }
}
...
class DessertDefinitions {
  ...
  static const butterRoll = DessertRecipe(
    ...
    sellPrice: 40,
    unlock: DessertUnlockCondition.defaultUnlocked(),
    sourceBottle: BlockColor.coral,
    directEnergyCost: 30,
    craftDurationSec: 20,
  );
  ...
  static const freshJuice = DessertRecipe(
    ...
    sellPrice: 35,
    unlock: DessertUnlockCondition.defaultUnlocked(),
    sourceBottle: BlockColor.teal,
    directEnergyCost: 30,
    craftDurationSec: 20,
  );
  static const rosePudding = DessertRecipe(
    id: 'rose_pudding',
    name: '黑糖布丁',
    emoji: '🍮',
    tier: 1,
  ...
  static const honeyToast = DessertRecipe(
    ...
    sellPrice: 80,
    unlock: DessertUnlockCondition.stageClear('1-5'),
    sourceBottle: BlockColor.coral,
    directEnergyCost: 60,
    craftDurationSec: 90,
  );
  ...
  static const chocolateCake = DessertRecipe(
    ...
    sellPrice: 90,
    unlock: DessertUnlockCondition.stageClear('1-8'),
  );
  ...
  static const cinnamonRoll = DessertRecipe(
    ...
    sellPrice: 80,
    unlock: DessertUnlockCondition.stageClear('1-10'),
    sourceBottle: BlockColor.coral,
    directEnergyCost: 60,
    craftDurationSec: 80,
  );
  ...
  static const cremeCaramel = DessertRecipe(
    ...
    sellPrice: 150,
    unlock: DessertUnlockCondition.stageClear('2-3'),
  );
  static const coconutTaroSago = DessertRecipe(
    id: 'coconut_taro_sago',
    name: '椰奶紫芋西米露',
    emoji: '🥥',
    tier: 3,
    ingredients: {'coconut_milk': 2, 'purple_yam': 1, 'brown_sugar': 1},
    sellPrice: 140,
    unlock: DessertUnlockCondition.stageClear('2-5'),
    sourceBottle: BlockColor.teal,
    directEnergyCost: 80,
    craftDurationSec: 180,
  );
  ...
  static const tiramisu = DessertRecipe(
    ...
    sellPrice: 170,
    unlock: DessertUnlockCondition.stageClear('2-8'),
    sourceBottle: BlockColor.teal,
    directEnergyCost: 80,
    craftDurationSec: 200,
  );
  static const saffronMillefeuille = DessertRecipe(
    id: 'saffron_millefeuille',
    name: '藏紅花千層',
    emoji: '🧁',
    tier: 3,
    ingredients: {
    ...
    sellPrice: 180,
    unlock: DessertUnlockCondition.stageClear('2-10'),
    sourceBottle: BlockColor.mint,
    directEnergyCost: 80,
    craftDurationSec: 240,
  );

  // ── Tier 4: 大師（Chapter 3 / 食譜購買）──
  static const moonlightMacaron = DessertRecipe(
    id: 'moonlight_macaron',
    name: '月光馬卡龍',
    emoji: '🌙',
    tier: 4,
    ingredients: {
    ...
    sellPrice: 280,
    unlock: DessertUnlockCondition.stageClear('3-3'),
    sourceBottle: BlockColor.rose,
    directEnergyCost: 100,
    craftDurationSec: 300,
  );
  static const magicRainbowCake = DessertRecipe(
    id: 'magic_rainbow_cake',
    name: '魔法彩虹蛋糕',
    emoji: '🌈',
    tier: 4,
    ingredients: {
    ...
    sellPrice: 350,
    unlock: DessertUnlockCondition.stageClear('3-5'),
  );
  static const stardustTruffle = DessertRecipe(
    ...
    sellPrice: 380,
    unlock: DessertUnlockCondition.stageClear('3-8'),
    sourceBottle: BlockColor.gold,
    directEnergyCost: 120,
    craftDurationSec: 300,
  );
  static const goldenCrownPuff = DessertRecipe(
    id: 'golden_crown_puff',
    name: '金箔皇冠泡芙',
    emoji: '👑',
    tier: 4,
    ingredients: {
    ...
    sellPrice: 400,
    unlock: DessertUnlockCondition.purchase(5000),
    sourceBottle: BlockColor.coral,
    directEnergyCost: 120,
    craftDurationSec: 360,
  );
  static const auroraMillefeuille = DessertRecipe(
    id: 'aurora_millefeuille',
    name: '極光千層酥',
    emoji: '🌌',
    tier: 4,
    ingredients: {
    ...
    sellPrice: 420,
    unlock: DessertUnlockCondition.purchase(8000),
  );
  static const patissierMasterpiece = DessertRecipe(
    id: 'patissier_masterpiece',
    name: '夢幻甜點師之作',
    emoji: '🏆',
    tier: 4,
    ingredients: {
    ...
    sellPrice: 500,
    unlock: DessertUnlockCondition.purchase(12000),
    sourceBottle: BlockColor.rose,
    directEnergyCost: 120,
    craftDurationSec: 360,
  );
  ...
  static List<DessertRecipe> all = const [
    // Tier 1
    butterRoll, mintTea, cocoaCookie, freshJuice, rosePudding,
    // Tier 2
    honeyToast, matchaLatte, chocolateCake, fruitTart, cinnamonRoll,
    // Tier 3
    cremeCaramel, coconutTaroSago, starryLollipop, tiramisu,
    saffronMillefeuille,
    // Tier 4
